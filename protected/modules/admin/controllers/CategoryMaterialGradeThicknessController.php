...
class CategoryMaterialGradeThicknessController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('CategoryMaterialGradeThickness');
	...
	{
		$model=CategoryMaterialGradeThickness::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='category-material-grade-thickness-form')
		{
