...
class StockGlobalController extends Controller {
    ...
    protected function saveToExcel($dataProvider) {
        ...
        $documentProperties->setTitle('Laporan Stok Barang Global');

        $worksheet = $objPHPExcel->setActiveSheetIndex(0);
        $worksheet->setTitle('Stok Barang Global');
...
//            $worksheet->setCellValue("F{$counter}", round($totalStockValue, 2));
        ...
        header('Content-Disposition: attachment;filename="laporan_stok_barang_global.xlsx"');
