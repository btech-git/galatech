...
<div id="memoheader">
    <div style="font-size: 2em"><?php echo $purchaseHeaderText; ?></div>
    <div style="font-size: larger">PENGAMBILAN BARANG</div>
</div>
...
<table class="memo">
    ...
    <tr class="titems">
        ...
        <td style="border-top: 2px solid;text-align: center; font-weight: bold"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', CHtml::value($purchase, 'subTotalQuantity'))); ?></td>
