...
<!--				<div class="row" style="background-color: #DFDFDF">
					Supplier
					<?php //echo CHtml::dropDownlist('SupplierId', $supplierId, CHtml::listData(Supplier::model()->findAll(), 'id', 'name'), array('empty'=>'-- Semua Supplier --')); ?>
                </div>-->
...
<!--				<div class="row" style="background-color: #DFDFDF">
					T / NT
					<?php //echo CHtml::activeDropDownlist($purchaseCheque, 'is_non_tax', array('1'=>'NonTax', '0'=>'Tax'), array('empty'=>'-- All --')); ?>
				</div>-->
                <div class="row">
					Tanggal Mulai
        ...
        <div class="clear"></div>
        <div class="right">
			<?php echo ReportHelper::sortText($sort, array('Tanggal')); ?>
        </div>
        <div class="clear"></div>
</div>
