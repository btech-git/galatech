...
<!--            <div class="row">
            ...
            <div>
                ...
                <?php
                echo CHtml::activeDropDownList($adjustment->header, 'warehouse_id', (TaxConnectionChecking::isCurrentConnectionSecondary()) ? CHtml::listData(Warehouse::model()->findAll(), 'id', 'name') : CHtml::listData(Warehouse::model()->findAll(), 'id', 'name'), array(
                    'onchange' => CHtml::ajax(array(
                        'type' => 'POST',
                        'url' => CController::createUrl('updateAllProductAjax'),
                        'update' => '#detail_div',
                    )),
                ));
                ?>
                <?php echo CHtml::error($adjustment->header, 'quantity'); ?>
            </div>
...
<div>
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'selectionChanged' => 'js:function(id) {
                        ...
                        $.ajax({
                                type: "POST",
                                url: "' . CController::createUrl('addProductAjax', array('id' => $adjustment->header->id, 'nt' => $adjustment->header->is_non_tax)) . '",
                                data: $("form").serialize(),
