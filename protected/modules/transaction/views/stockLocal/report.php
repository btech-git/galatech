...
<div class="hide">
    <div class="form" style="text-align: center">
        ...
        <div class="row" style="background-color: #BFBFBF">
            Gudang
            <?php echo CHtml::dropDownlist('WarehouseId', $warehouseId, CHtml::listData(Warehouse::model()->findAll(), 'id', 'name')); ?>
        </div>
...
<div>
    <?php $this->renderPartial('_report', array('dataProvider' => $dataProvider, 'warehouseId' => $warehouseId)); ?>
</div>
