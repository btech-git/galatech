...
<table class="memo">
    ...
    <tr class="titems">
        ...
        <td style="border-top: 2px solid;text-align: center; font-size: 12px;">
            <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', (CHtml::value($delivery, 'subTotalQuantity')))); ?>
        </td>
