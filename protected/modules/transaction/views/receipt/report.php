...
<!--                <div class="row" style="background-color: #DFDFDF">
                        Number
                        <?php //echo CHtml::activeDropDownlist($receipt, 'number', CHtml::listData(ReceiptHeader::model()->findAll(), 'id', 'number'), array('empty'=>'-- Semua Number--')); ?>
                </div>-->
				
				<div class="row" style="background-color: #DFDFDF">
                        Customer
                        <?php echo CHtml::activeDropDownlist($receipt, 'customer_id', CHtml::listData(Customer::model()->findAll(), 'id', 'name'), array('empty'=>'-- Semua Customer --')); ?>
                </div>
