...
<table style="border: 1px solid">
                        ...
                        <?php if ($detail->isNewRecord): ?>
                                <?php echo CHtml::button('Delete', array(
                                        'onclick'=>CHtml::ajax(array(
                                                'type'=>'POST',
                                                'url'=>CController::createUrl('removeAccountAjax', array('id'=>$deposit->header->id, 'index'=>$i)),
                                                'update'=>'#detail_div',
                                        )),
                                )); ?>
                        <?php else: ?>
        ...
        <tr style="background-color: aquamarine">
                ...
                <td style="font-weight: bold; text-align: center">
                        <span id="total">
                                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $deposit->total)); ?></td>
                        </span>
                <td></td>
                <td></td>
        </tr>
