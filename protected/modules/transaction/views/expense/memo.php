...
<div id="memoheader">
	<div style="font-size: larger"><?php echo $expenseHeaderText; ?></div>
		...
		<div class="divtablecell hcolumn1">
			<div class="divtable">
				<div class="divtablerow">
					...
					<div class="divtablecell info hcolumn1value"><?php echo CHtml::encode(CHtml::value($expense, 'number')); ?></div>
				</div>
				<div class="divtablerow">
		...
		<div class="divtablecell hcolumn2">
			<div class="divtable">
				<div class="divtablerow">
					...
					<div class="divtablecell info hcolumn2value"><?php echo CHtml::encode(CHtml::value($expense, 'account.name')); ?></div>
				</div>
				<div class="divtablerow">
...
<table class="memo">
	...
	<tr>
		...
		<td style="border-top: 2px solid; font-weight: bold; text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', floor(CHtml::value($expense, 'total')))); ?></td>
