...
<div class="hide">
	...
	<?php echo CHtml::beginForm(array(''), 'get'); ?>
		...
		<div class="row" style="background-color: #DFDFDF">
			Nama Akun
			<?php echo CHtml::activeDropDownlist($accountingJournal, 'account_id', CHtml::listData(Account::model()->findAll(), 'id', 'name'), array('empty'=>'-- Semua Akun --')); ?>
		</div>
	...
	<div class="clear"></div>
	<div class="right">
		<?php echo ReportHelper::sortText($sort, array('Tanggal', 'Nama Akun')); ?>
	</div>
	<div class="clear"></div>
</div>
