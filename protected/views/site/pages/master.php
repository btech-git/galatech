	...
	<fieldset>
		<legend>Data Pembantu</legend>
			<ul style="display: table-cell; width: 800px">
				...
				<li class="left" style="width: 50%"><?php echo CHtml::link('Category Classification Material', array('/admin/categoryMaterial/admin')); ?><br/><br/></li>
				...
				<li class="left" style="width: 50%"><?php echo CHtml::link('Category Classification Connection', array('/admin/categoryConnection/admin')); ?><br/><br/></li>
				<li class="left" style="width: 50%"><?php echo CHtml::link('Disc Material', array('/admin/discMaterial/admin')); ?></li>
				<li class="left" style="width: 50%"><?php echo CHtml::link('Category Classification Variety', array('/admin/categoryVariety/admin')); ?><br/><br/></li>
				...
				<li class="left" style="width: 50%"><?php echo CHtml::link('Bank', array('/admin/bank/admin')); ?></li>
			</ul>
	</fieldset>
</div>
