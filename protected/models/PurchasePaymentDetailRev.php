...
/**
 * This is the model class for table "tblgt_purchase_payment_detail_rev".
 *
 * The followings are the available columns in table 'tblgt_purchase_payment_detail_rev':
 * @property integer $id
 ...
 */
class PurchasePaymentDetailRev extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PurchasePaymentDetailRev the static model class
	 */
	...
	{
		return 'tblgt_purchase_payment_detail_rev';
	}
	...
	public function rules()
	{
		...
		return array(
			array('purchase_payment_header_rev_id, purchase_receipt_header_id, account_id', 'required'),
			array('purchase_payment_header_rev_id, purchase_receipt_header_id, account_id, is_inactive', 'numerical', 'integerOnly'=>true),
			array('amount', 'length', 'max'=>18),
			array('memo', 'length', 'max'=>60),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, amount, memo, purchase_payment_header_rev_id, purchase_receipt_header_id, account_id, is_inactive', 'safe', 'on'=>'search'),
		);
	}
