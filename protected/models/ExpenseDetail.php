...
/**
 * This is the model class for table "tblgt_expense_detail".
 *
 * The followings are the available columns in table 'tblgt_expense_detail':
 * @property integer $id
 ...
 */
class ExpenseDetail extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return ExpenseDetail the static model class
	 */
