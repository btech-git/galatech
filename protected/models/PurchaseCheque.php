...
/**
 * This is the model class for table "tblgt_purchase_cheque".
 *
 * The followings are the available columns in table 'tblgt_purchase_cheque':
 * @property integer $id
 ...
 */
class PurchaseCheque extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return PurchaseCheque the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('number, issue_date, due_date, cheque_number, bank, purchase_receipt_header_id, admin_id', 'required'),
			...
			array('id, number, issue_date, due_date, cheque_number, note, bank, amount, purchase_receipt_header_id, admin_id, is_non_tax, is_inactive', 'safe', 'on'=>'search'),
		);
	}
