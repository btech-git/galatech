...
/**
 * This is the model class for table "tblgt_journal_voucher_detail".
 *
 * The followings are the available columns in table 'tblgt_journal_voucher_detail':
 * @property integer $id
 ...
 */
class JournalVoucherDetail extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return JournalVoucherDetail the static model class
	 */
	...
	{
		return 'tblgt_journal_voucher_detail';
	}
	...
	public function search()
	{
		...
		$criteria->compare('journal_voucher_header_id',$this->journal_voucher_header_id);
