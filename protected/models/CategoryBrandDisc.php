...
/**
 * This is the model class for table "tblgt_category_brand_disc".
 *
 * The followings are the available columns in table 'tblgt_category_brand_disc':
 * @property integer $id
 ...
 */
class CategoryBrandDisc extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return CategoryBrandDisc the static model class
	 */
	...
	{
		return 'tblgt_category_brand_disc';
	}
