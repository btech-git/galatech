...
/**
 * This is the model class for table "tblgt_category_connection".
 *
 * The followings are the available columns in table 'tblgt_category_connection':
 * @property integer $id
 ...
 */
class CategoryConnection extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return CategoryConnection the static model class
	 */
	...
	{
		return 'tblgt_category_connection';
	}
