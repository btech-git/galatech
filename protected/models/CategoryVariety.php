...
/**
 * This is the model class for table "tblgt_category_variety".
 *
 * The followings are the available columns in table 'tblgt_category_variety':
 * @property integer $id
 ...
 */
class CategoryVariety extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return CategoryVariety the static model class
	 */
