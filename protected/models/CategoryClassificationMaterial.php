...
/**
 * This is the model class for table "tblgt_category_classification_material".
 *
 * The followings are the available columns in table 'tblgt_category_classification_material':
 * @property integer $id
 ...
 */
class CategoryClassificationMaterial extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return CategoryClassificationMaterial the static model class
	 */
	...
	{
		return 'tblgt_category_classification_material';
	}
