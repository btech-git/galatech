...
/**
 * This is the model class for table "tblgt_payment_type".
 *
 * The followings are the available columns in table 'tblgt_payment_type':
 * @property integer $id
...
class PaymentType extends ActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'salesPaymentDetails' => array(self::HAS_MANY, 'SalesPaymentDetail', 'payment_type_id'),
		);
	}
