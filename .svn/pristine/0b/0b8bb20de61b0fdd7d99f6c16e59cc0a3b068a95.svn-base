...
<!--            <div class="row">
            ...
            <div class="row">
                ...
                <?php
                echo CHtml::activeDropDownList($transfer->header, 'warehouse_id_from', CHtml::listData(Warehouse::model()->findAll(), 'id', 'name'), array(
...
<div>
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'selectionChanged' => 'js:function(id) {
			...
			$.ajax({
				type: "POST",
				url: "' . CController::createUrl('addProductAjax', array('id' => $transfer->header->id, 'nt' => $transfer->header->is_non_tax)) . '",
				data: $("form").serialize(),
