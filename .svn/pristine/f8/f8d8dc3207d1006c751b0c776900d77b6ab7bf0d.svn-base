...
/**
 * This is the model class for table "tblgt_disc_material".
 *
 * The followings are the available columns in table 'tblgt_disc_material':
 * @property integer $id
 ...
 */
class DiscMaterial extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return DiscMaterial the static model class
	 */
