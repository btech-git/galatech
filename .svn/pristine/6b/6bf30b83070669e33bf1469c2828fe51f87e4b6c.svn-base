<?php if ($error === true && count($indent->details) === 0): ?>
            ...
            <td style="text-align: center; width: 5%">
                ...
                echo CHtml::activeTextField($detail, "[$i]quantity", array('size' => 7, 'maxLength' => 20,
                    ...
                    CHtml::ajax(array(
                        'type' => 'POST',
                        'dataType' => 'JSON',
                        'url' => CController::createUrl('totalAjaxData', array('id' => $indent->header->id, 'index' => $i)),
                ...
                <?php if ($detail->isNewRecord): ?>
                    ...
                    echo CHtml::button('Delete', array(
                        'onclick' => CHtml::ajax(array(
                            'type' => 'POST',
                            'url' => CController::createUrl('removeProductAjax', array('id' => $indent->header->id, 'index' => $i)),
                            'update' => '#detail_div',
                        )),
                    ));
                    ?>
