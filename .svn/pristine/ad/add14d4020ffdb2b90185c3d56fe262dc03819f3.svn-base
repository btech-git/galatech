...
<div class="form">
    ...
    <div class="container">
        <div class="span-12">
            <div class="row">
                ...
                <?php echo CHtml::encode(CHtml::value($indent->header, 'number')); ?>
                <?php echo CHtml::error($indent->header, 'number'); ?>
            </div>
            ...
            <div class="row">
                ...
                <?php echo CHtml::encode(CHtml::value($indent->header, 'customer.company')); ?>
    ...
    <div id="detail_div">
        <?php $this->renderPartial('_detail', array('indent' => $indent, 'error' => $error)); ?>
    </div>
...
<div>
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'selectionChanged' => 'js:function(id) {
                        ...
                        $.ajax({
                                type: "POST",
                                url: "' . CController::createUrl('addProductAjax', array('id' => $indent->header->id, 'nt' => $indent->header->is_non_tax)) . '",
                                data: $("form").serialize(),
