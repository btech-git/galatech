...
//                $dataProvider->criteria->with = array('purchaseHeader');
        ...
        $dataProvider->criteria->compare('purchaseHeader.number', $purchaseNumber, true);
