...
<table class="report">
			...
			<td colspan="6">
				<table>
					<tr>
						...
						<th class="width2-3">Jumlah Terjual</th>
						<th class="width2-4">Jumlah Retur</th>
						<th class="width2-5">Satuan</th>
						<th class="width2-6">Harga Satuan</th>
        ...
        <?php foreach ($dataProvider->data as $header): ?>
			<tr class="items1">
				...
				<td class="width1-3"><?php echo CHtml::encode(CHtml::value($header, 'invoiceHeader.number')); ?></td>
				<td class="width1-4" style="text-align: right"><?php echo CHtml::encode(CHtml::value($header, ($header->is_non_tax) ? 'invoiceHeader.deliveryHeader.customer.name' : 'invoiceHeader.deliveryHeader.customer.company')); ?></td>
			...
			<tr class="items2">
				<td colspan="6">
					<table>
						<?php foreach ($header->salesReturnDetails as $detail): ?>
							<tr>
								...
								<td class="width2-5"><?php echo CHtml::encode(CHtml::value($detail, 'product.unit.name')); ?></td>
        ...
        <tr>
			...
			<td class="width2-6" style="border-top: 1px solid; font-weight: bold; text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', ceil($this->reportGrandTotal($dataProvider)))); ?></td>
        </tr>
</table>
