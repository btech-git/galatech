...
/**
 * This is the model class for table "tblgt_receipt_detail".
 *
 * The followings are the available columns in table 'tblgt_receipt_detail':
 * @property integer $id
 ...
 */
class ReceiptDetail extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return ReceiptDetail the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('invoice_header_id, receipt_header_id', 'required'),
			array('invoice_header_id, receipt_header_id, is_inactive', 'numerical', 'integerOnly'=>true),
			array('memo', 'length', 'max'=>60),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, memo, invoice_header_id, receipt_header_id, is_inactive', 'safe', 'on'=>'search'),
		);
	}
