...
<table class="report">
        ...
        <tr id="header2">
                <td colspan="4">
                        <table>
                                <tr>
                                        <th class="width2-1">Nama Asset</th>
        ...
        <?php foreach ($dataProvider->data as $header): ?>
                <tr class="items1">
                        ...
                        <td class="width1-3" style="text-align: right"><?php echo CHtml::encode(CHtml::value($header, 'customer')); ?></td>
                        <td class="width1-4" style="text-align: right"><?php echo CHtml::encode(CHtml::value($header, 'note')); ?></td>
                </tr>
                <tr class="items2">
                        <td colspan="4">
                                <table>
                                        <?php foreach ($header->salesAssetDetails as $detail): ?>
                                                <tr>
        ...
        <tr>
                ...
                <td class="width2-3" style="border-top: 1px solid; font-weight: bold; text-align: right">TOTAL PENJUALAN</td>
