...
class CategoryMaterialGradeController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('CategoryMaterialGrade');
	...
	{
		$model=CategoryMaterialGrade::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='category-material-grade-form')
		{
