...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo CHtml::activeDropDownList($model, 'category_material_grade_id', CHtml::listData(CategoryMaterialGrade::model()->findAll(), 'id', 'name')); ?>
		<?php echo $form->error($model,'category_material_grade_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'thickness_id'); ?>
		<?php echo CHtml::activeDropDownList($model, 'thickness_id', CHtml::listData(Thickness::model()->findAll(), 'id', 'name')); ?>
