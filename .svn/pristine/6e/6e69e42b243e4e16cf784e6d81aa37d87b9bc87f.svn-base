...
//				$model->attributes = $_POST['Product'];
				$model->header->unsetAttributes(array('material_id', 'grade_id', 'thickness_id', 'type_id', 'brand_id', 'disc_material_id', 'body_type_id', 'connection_id', 'classification_id', 'variety_id', 'handling_id'));
			}
	...
	public function actionCategorySelectionAjaxData($emptyText = '')
	{
		if (Yii::app()->request->isAjaxRequest)
		{
			...
			$classificationOptions = CHtml::listOptions('', $classificationList, ($htmlOptions = array('empty' => $emptyText)));
			$connectionOptions = CHtml::listOptions('', $connectionList, ($htmlOptions = array('empty' => $emptyText)));
			$gradeOptions = CHtml::listOptions('', $gradeList, ($htmlOptions = array('empty' => $emptyText)));
			$materialOptions = CHtml::listOptions('', $materialList, ($htmlOptions = array('empty' => $emptyText)));
			$thicknessOptions = CHtml::listOptions('', $thicknessList, ($htmlOptions = array('empty' => $emptyText)));
			$typeOptions = CHtml::listOptions('', $typeList, ($htmlOptions = array('empty' => $emptyText)));
			$varietyOptions = CHtml::listOptions('', $varietyList, ($htmlOptions = array('empty' => $emptyText)));
	...
	public function actionBrandSelectionAjaxData($emptyText = '')
	{
		if (Yii::app()->request->isAjaxRequest)
		{
			...
			$bodyOptions = CHtml::listOptions('', $bodyList, ($htmlOptions = array('empty' => $emptyText)));
			$connectionOptions = CHtml::listOptions('', $connectionList, ($htmlOptions = array('empty' => $emptyText)));
			$discOptions = CHtml::listOptions('', $discList, ($htmlOptions = array('empty' => $emptyText)));
			$handlingOptions = CHtml::listOptions('', $handlingList, ($htmlOptions = array('empty' => $emptyText)));
			$typeOptions = CHtml::listOptions('', $typeList, ($htmlOptions = array('empty' => $emptyText)));
