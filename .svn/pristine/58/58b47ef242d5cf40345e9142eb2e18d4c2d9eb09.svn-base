...
<div class="hide">
        ...
        <?php echo CHtml::beginForm(array(''), 'get'); ?>
                ...
                <div class="row" style="background-color: #DFDFDF">
                        Supplier
                        <?php echo CHtml::activeDropDownlist($purchaseHeader, 'supplier_id', CHtml::listData(Supplier::model()->findAll(), 'id', 'name'), array('empty'=>'-- Semua Supplier --')); ?>
                </div>
			
				<?php if (TaxConnectionChecking::isCurrentConnectionSecondary()): ?>
					<div class="row" style="background-color: #DFDFDF">
							T / NT
							<?php echo CHtml::activeDropDownlist($purchaseHeader, 'is_non_tax', array('1'=>'NonTax', '0'=>'Tax'), array('empty'=>'-- All --')); ?>
					</div>
				<?php endif; ?>
