...
/**
 * This is the model class for table "tblgt_category_grade".
 *
 * The followings are the available columns in table 'tblgt_category_grade':
 * @property integer $id
 ...
 */
class CategoryGrade extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return CategoryGrade the static model class
	 */
