                ...
                <td colspan="7">
                        <table>
                                <tr>
                                        ...
                                        <th class="width2-4">Jumlah Pesanan</th>
                                        <th class="width2-5">Jumlah Diterima</th>
                                </tr>
                        </table>
                </td>
        </tr>
                                ...
                                <table>
                                        <?php foreach ($header->receiveDetails as $detail): ?>
                                                <tr>
                                                        ...
                                                        <td class="width2-4" style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', CHtml::value($detail, 'quantityOrdered'))); ?></td>
