...
<div style="font-weight: bold; text-align: center">
	...
	<div style="font-size: larger">Laporan Hutang Pembelian Barang</div>
...
<table class="report">
				...
				<table>
					 <?php foreach ($header->purchaseReceiptDetails as $detail): ?>
						<tr>
							...
							<td class="width2-2" style="text-align: center"><?php echo CHtml::encode(Yii::app()->dateFormatter->format('d MMMM yyyy', strtotime($detail->purchaseInvoice->date))); ?></td>
							<td class="width2-3" style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', $detail->purchaseInvoice->totalPurchase)); ?></td>
						</tr>
					<?php endforeach; ?>	
				</table>	
			</td>
	...
	<?php endforeach; ?>
	<tr>
		<td colspan="4" style="border-top: 1px solid; font-weight: bold; text-align: right">TOTAL HUTANG</td>
		<td colspan="2" style="border-top: 1px solid; font-weight: bold; text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', floor($this->reportTotalPayable($dataProvider)))); ?></td>
	</tr>
</table>			
