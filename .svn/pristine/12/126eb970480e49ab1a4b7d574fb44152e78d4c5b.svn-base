...
/**
 * This is the model class for table "tblgt_category_brand_type".
 *
 * The followings are the available columns in table 'tblgt_category_brand_type':
 * @property integer $id
 ...
 */
class CategoryBrandType extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return CategoryBrandType the static model class
	 */
	...
	{
		return 'tblgt_category_brand_type';
	}
