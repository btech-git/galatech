...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <div class="row">
                ...
                <?php if ($model->isNewRecord): ?>
                        <?php echo $form->dropDownList($model,'category_id', CHtml::listData(Category::model()->findAll(), 'id', 'name'), array('empty'=>'-- Select Category --',
	...
	<div class="row">
		<?php echo $form->label($model,'COGS Average'); ?>
		<?php echo $form->textField($model,'weighted_purchase_price',array('size'=>18,'maxlength'=>18)); ?>
		<?php echo $form->error($model,'weighted_purchase_price'); ?>
	</div>
