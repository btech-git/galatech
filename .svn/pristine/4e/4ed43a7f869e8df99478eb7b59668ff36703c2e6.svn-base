...
/**
 * This is the model class for table "tblgt_category_thickness".
 *
 * The followings are the available columns in table 'tblgt_category_thickness':
 * @property integer $id
 ...
 */
class CategoryThickness extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return CategoryThickness the static model class
	 */
	...
	{
		return 'tblgt_category_thickness';
	}
