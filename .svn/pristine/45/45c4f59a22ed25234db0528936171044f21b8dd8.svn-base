<h1>Pemesanan Pembelian Barang</h1>
...
<div class="form">
    ...
    <div class="container">
        <div class="span-12">
            <?php if (!empty($purchase->header->id)): ?>
                <div class="row">
            ...
            <div class="row">
                ...
                $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                    ...
                    'sourceUrl' => CController::createUrl('supplierCompletion'),
...
?>
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'selectionChanged' => 'js:function(id) {
                        ...
                        $.ajax({
                                type: "POST",
                                url: "' . CController::createUrl('addProductAjax', array('id' => $purchase->header->id, 'nt' => $purchase->header->is_non_tax)) . '",
                                data: $("form").serialize(),
