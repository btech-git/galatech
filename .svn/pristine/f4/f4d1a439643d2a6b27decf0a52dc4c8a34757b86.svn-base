...
/**
 * This is the model class for table "tblgt_category_classification_connection".
 *
 * The followings are the available columns in table 'tblgt_category_classification_connection':
 * @property integer $id
 ...
 */
class CategoryClassificationConnection extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return CategoryClassificationConnection the static model class
	 */
	...
	{
		return 'tblgt_category_classification_connection';
	}
