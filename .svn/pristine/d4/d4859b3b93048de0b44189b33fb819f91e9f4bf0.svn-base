...
/**
 * This is the model class for table "tblgt_thickness".
 *
 * The followings are the available columns in table 'tblgt_thickness':
 * @property integer $id
 ...
 */
class Thickness extends ActiveRecord
{
	/**
