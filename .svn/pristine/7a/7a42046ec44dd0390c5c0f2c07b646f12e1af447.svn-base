...
<div id="memoheader">
    <div style="font-size: 14px"><?php echo $deliveryHeaderText; ?></div>
    <div style="font-size: 14px">SURAT JALAN</div>
</div>
        ...
        <div class="divtablecell hcolumn1">
            <div class="divtable">
                <div class="divtablerow">
                    ...
                    <div class="divtablecell info hcolumn1value"><?php echo CHtml::encode(CHtml::value($delivery, 'number')); ?></div>
                </div>
                <div class="divtablerow">
                ...
                <div class="divtablerow">
                    <div class="divtablecell info hcolumn1header" style="font-weight: bold">Info</div>
                    <div class="divtablecell info hcolumn1value"><?php echo CHtml::encode(CHtml::value($delivery, 'warehouse.code')); ?></div>
                </div>
            </div>
        </div>
        <div class="divtablecell hcolumn2">
            <div class="divtable">
                <div class="divtablerow">
                    ...
                    <div class="divtablecell info hcolumn2value"><?php echo $deliveryCustomer; ?></div>
                </div>
                <div class="divtablerow">
                    <div class="divtablecell info hcolumn1header" style="font-weight: bold">Dibuat oleh</div>
                    <div class="divtablecell info hcolumn1value"><?php echo CHtml::encode(CHtml::value($delivery, 'admin.name')); ?></div>
                </div>
                <div class="divtablerow">
                    <div class="divtablecell info hcolumn2header" style="font-weight: bold">Pengirim</div>
                    <div class="divtablecell info hcolumn2value"><?php echo CHtml::encode(CHtml::value($delivery, 'driver')); ?></div>
                </div>
            </div>
        </div>
    </div>
...
<table class="memo">
    ...
    <tr class="titems">
        ...
        <td style="border-top: 2px solid;text-align: center;"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', (CHtml::value($delivery, 'subTotalQuantity')))); ?></td>
        <td style="border-top: 2px solid;">&nbsp;</td>
    </tr>
</table>

<div>
    <span style="font-weight: bold">Catatan: </span> <?php echo CHtml::value($delivery, 'note'); ?>
</div>
<br />
